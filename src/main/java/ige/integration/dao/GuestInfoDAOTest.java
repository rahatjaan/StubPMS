...
public class GuestInfoDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private GuestInfoDAO dataStore;

	/**
	 * Instantiates a new GuestInfoDAOTest.
	 *
	 */
	public GuestInfoDAOTest() {
	}

	/**
	 * Method to test GuestInfo domain object.
	 *
	 */
	@Rollback(false)
	@Test
	public void GuestInfo() {
		GuestInfo instance = new GuestInfo();
	 ...
	 */
	@Autowired
	public void setDataStore(GuestInfoDAO dataStore) {
