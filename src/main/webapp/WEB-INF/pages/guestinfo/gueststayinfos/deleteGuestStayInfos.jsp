...
<html>
<head>
<title>View <fmt:message key="guestinfo.title"/> <fmt:message key="gueststayinfo.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			<h1><fmt:message key="navigation.view"/> <fmt:message key="gueststayinfo.title"/></h1>
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteGuestInfoGuestStayInfos?guestinfo_id=${guestinfo_id}&related_gueststayinfos_id=${gueststayinfo.id}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
